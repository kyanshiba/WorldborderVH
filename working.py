                ...
                for msg in console:
                    if msg.Type == "Console" and msg.Source == "Server thread/INFO":
                        ...
                        if "completed" in log_content and "Vault!" in log_content:
                            ...
                            await Hub.Core.SendConsoleMessageAsync(f"say wait counter: {open_vault_wait_counter}")
                            await Hub.Core.SendConsoleMessageAsync(f"say players in vault: {players_in_vault}")
